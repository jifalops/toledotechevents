...
final _eventsResource = StringNetworkResource(
  url: 'http://toledotechevents.org/events.atom',
  filename: 'events.atom',
  maxAge: Duration(minutes: 60),
);

final _venuesResource = StringNetworkResource(
  url: 'http://toledotechevents.org/venues.json',
  filename: 'venues.json',
  maxAge: Duration(minutes: 60),
);

final _aboutPageResource = StringNetworkResource(
  url: 'http://toledotechevents.org/about.html',
  filename: 'about.html',
  maxAge: Duration(hours: 24),
);

final _newEventPageResource = StringNetworkResource(
